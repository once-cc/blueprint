...
export interface DeliveryMobileCardProps {
    index: number;
                        ...
                        <div className="absolute inset-0 z-10 p-5 flex flex-col justify-between">
                            ...
                            <div className="grid grid-cols-[50%_1fr]">
                                <div>
                                    ...
                                    >
                                        <span className="text-[#d4a853]/60">//</span> 03
                                    </motion.span>
                                ...
                                <div>
                                    ...
                                    <motion.h3
                                        ...
                                        {...(isInView
                                            ...
                                            : { initial: { opacity: 0 } })}
                                    >
                                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#e8e0d4] to-[#e8e0d4]/60 inline-block pr-1 mix-blend-plus-lighter" style={{ filter: 'drop-shadow(0px 2px 4px rgba(0,0,0,0.5))' }}>
                                            {step.title}
                                        </span>
                                    </motion.h3>
                                </div>

...
export const TypographyMotionStep = forwardRef<HTMLDivElement, TypographyMotionStepProps>(
  function TypographyMotionStep({
    ...
    // Validation
    const isValid = !!(design.typographyStyle);
    
    // Get current selected style
    const selectedStyle = typographyStyles.find(s => s.value === design.typographyStyle);
    ...
    return (
      <StepLayout
        ...
        stepNumber={5}
        title="Typography"
        framing="Choose the typographic personality that represents your brand."
        helperText={!isValid ? "Select a typography style to continue" : undefined}
        onBack={onBack}
        onNext={onNext}
        canGoNext={isValid}
      >
        <div className="space-y-6">
          ...
          >
            <ConfiguratorDropdown
              ...
              required
              value={design.typographyStyle ?? null}
              onChange={(value) => onUpdate({ typographyStyle: value as BlueprintDesign['typographyStyle'] })}
            ...
            {design.typographyStyle && (
              ...
              >
                ...
                <AnimatePresence mode="popLayout">
                  {(() => {
                    const style = typographyStyles.find(s => s.value === design.typographyStyle);
